...
CREATE TABLE `advogado` (
  ...
  `cadastro_completo` int NOT NULL DEFAULT '0',
  PRIMARY KEY (`id_adv`),
...
INSERT INTO `advogado` VALUES (3,'Ricardo','Braunn','saf@gmail.com',1,'123454','teste','2e6f9b0d5885b6010f9167787445617f553a735f','Uniuv 2020',NULL,1),(4,'ggggg','ggggggg','saf@gmail.com',1,'11111111','asd','2e6f9b0d5885b6010f9167787445617f553a735f','d',NULL,0),(5,'Teste login','as','a@g.com',11,'1234','fg','123','a',NULL,0),(6,'Ricardo','Braunn','rick@u.com',1,'2134123513','test','2e6f9b0d5885b6010f9167787445617f553a735f','s',NULL,0),(7,'Ricardo','Vergutz','rc@uniuv.edu',2,'(54)55454-5455','teste1a','2e6f9b0d5885b6010f9167787445617f553a735f','Uniuv 2021',NULL,0),(8,'Ricardo','Almeida','ricardoalmeidabraunn@gmail.com',12,'(55)55555-5555','Ricardo A.','2e6f9b0d5885b6010f9167787445617f553a735f','abcd',NULL,0);
...
INSERT INTO `area` VALUES (1,'Criminal','Area Criminal do Direito'),(2,'Civil','Area Civil');
...
INSERT INTO `area_adv` VALUES (3,1),(3,2);
...
CREATE TABLE `avaliacao` (
  ...
  `descricao` text,
  `data_avali` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `id_adv` int NOT NULL,
  `id_cli` int NOT NULL,
  `status` varchar(100) DEFAULT 'Ativo',
  PRIMARY KEY (`id_avaliacao`),
  KEY `fk_Avaliacao_Advogado1_idx` (`id_adv`),
  KEY `fk_Avaliacao_Cliente1_idx` (`id_cli`),
  CONSTRAINT `fk_Avaliacao_Advogado1` FOREIGN KEY (`id_adv`) REFERENCES `advogado` (`id_adv`),
  CONSTRAINT `fk_Avaliacao_Cliente1` FOREIGN KEY (`id_cli`) REFERENCES `cliente` (`id_cli`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `avaliacao` VALUES (1,5,'Teste','sadsad','2020-10-19 19:00:36',3,6,'Ativo');
...
INSERT INTO `cliente` VALUES (6,'Ricardo','Braunn','rick@hg.com',1,'44443','teste','2e6f9b0d5885b6010f9167787445617f553a735f',NULL),(7,'Ricardo A.','Braunn','ricardoalmeidabraunn@gmail.com',12,'(54)54555-5555','Ricardo ','2e6f9b0d5885b6010f9167787445617f553a735f',NULL);
...
INSERT INTO `documento` VALUES (1,'cupom-growth-suplements.png',2),(2,'teste-nullo.png',4),(4,'TCC FINAL.pdf',6),(5,'TCC FINAL.pdf',6);
...
CREATE TABLE `notificacao` (
  ...
  `url_noti` varchar(255) DEFAULT NULL,
...
INSERT INTO `notificacao` VALUES (1,'3','adv','Sua solicitação foi aceita pelo Advogado',NULL,NULL,NULL),(2,'3','adv','Sua solicitação foi aceita pelo Advogado','0002-02-02 00:00:00',NULL,NULL),(3,'6','cli','Sua solicitação foi aceita pelo Advogado',NULL,NULL,NULL),(4,'6','cli','Sua solicitação foi recusada pelo Advogado',NULL,NULL,NULL),(5,'3','adv','Você Recebeu uma nova Solicitação!',NULL,'/solicitacao','fa-balance-scale');
...
INSERT INTO `oab` VALUES (4,'66661',1,NULL,4,'Aprovado'),(5,'12345',1,NULL,4,'Aguardando Avaliacao'),(6,'12346',1,NULL,4,'Aguardando Avaliacao'),(7,'66666',1,NULL,4,'Reprovado'),(8,'12340',1,NULL,3,'Aprovado'),(9,'00.000',1,NULL,8,'Aguardando Avaliacao');
...
INSERT INTO `solicitacoes` VALUES (1,'teste','2020-08-12 19:35:05',3,6,'Recusado'),(2,'testee\n','2020-10-05 16:32:26',3,6,'Aceito'),(4,'Teste status\n','2020-10-21 13:09:53',3,6,'Pendente'),(5,'JHFHKGSJKHSDGFKLJ','2020-10-26 19:57:45',3,6,'Aceito'),(6,'','2020-11-04 18:23:35',3,6,'Pendente');
...
-- Dump completed on 2020-11-10 16:47:59
